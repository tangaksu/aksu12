            ...
            <table class="form-table wpss-fw-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description" style="color:#888;">
                            <b>填写说明：</b>每行填写一组规则，同一行内可用 <b>|</b> 分隔多个内容，命中任意一个即拦截。 <span style="cursor:pointer;color:#2271b1;" onclick="var e=document.getElementById('ua_blacklist_example');e.style.display=e.style.display==='none'?'block':'none';this.blur();">[示例]</span>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description" style="color:#888;">
                            <b>填写说明：</b>每行填写一组规则，同一行内可用 <b>|</b> 分隔多个内容，命中任意一个即拦截。 <span style="cursor:pointer;color:#2271b1;" onclick="var e=document.getElementById('uri_rules_example');e.style.display=e.style.display==='none'?'block':'none';this.blur();">[示例]</span>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <div style="color:#888;font-size:13px;">此处填写反馈给客户端的400错误页面内容，支持HTML。</div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <div style="color:#888;font-size:13px;">此处填写反馈给客户端的403错误页面内容，支持HTML。</div>
                    </td>
                </tr>
            </table>
