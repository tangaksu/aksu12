...
function aksu_set_security_headers() {
    ...
    header("Content-Security-Policy: default-src 'self'; img-src * data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' *.google-analytics.com; style-src 'self' 'unsafe-inline'; font-src 'self' data:; frame-ancestors 'self'; base-uri 'self'; form-action 'self'");
    // 防止浏览器自动下载文件而非展示
