...
if (!function_exists('aksu_uri_defend')) {
    function aksu_uri_defend() {
        ...
        $dangerous_uri_patterns = [
            ...
            '/\x00/', // 空字节注入
            // 常见扫描、探针、后门路径
            '/(phpmyadmin|adminer|wp-config|wp-adminer|\.env|shell\.php|webshell\.php|cmd\.php|info\.php|test\.php|dbadmin|pma|mysql|www\.zip|backup\.zip|setup\.php|install\.php|config\.inc\.php|\.\.\/\.\.\/)/i',
            // SQL注入特征
